...
public:
  ...
  /// Used when the user taps an alternative ETA balloon. Returns false if the result is stale,
  /// the index is out of range or already active. Rebuilds m_route from the selected RouteBase.
